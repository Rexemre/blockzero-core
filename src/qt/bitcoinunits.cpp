...
{
    switch (unit) {
    case Unit::BTC: return QString("BLOZ");
    case Unit::mBTC: return QString("mBLOZ");
    case Unit::uBTC: return QString::fromUtf8("µBLOZ (bits)");
...
QString BitcoinUnits::description(Unit unit)
{
    switch (unit) {
    case Unit::BTC: return QString("BLOZ");
    case Unit::mBTC: return QString("Milli-BLOZ (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BLOZ (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
