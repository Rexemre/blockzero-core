...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET bitcoin-qt)
    set(macos_app "Block Zero.app")
    # Populate Contents subdirectory.
    configure_file(${PROJECT_SOURCE_DIR}/share/qt/Info.plist.in ${macos_app}/Contents/Info.plist NO_SOURCE_PERMISSIONS)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/PkgInfo CONTENT "APPL????")
    # Populate Contents/Resources subdirectory.
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/empty.lproj CONTENT "")
    configure_file(${PROJECT_SOURCE_DIR}/src/qt/res/icons/bloz.icns ${macos_app}/Contents/Resources/bloz.icns NO_SOURCE_PERMISSIONS COPYONLY)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/Base.lproj/InfoPlist.strings
      CONTENT "{ CFBundleDisplayName = \"@CLIENT_NAME@\"; CFBundleName = \"@CLIENT_NAME@\"; }"
    )

    add_custom_command(
      OUTPUT "${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Block Zero"
      ...
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:bitcoin-qt> "${macos_app}/Contents/MacOS/Block Zero"
    ...
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS "${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Block Zero"
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT "${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Block Zero"
      ...
      add_custom_target(deploydir
        DEPENDS "${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Block Zero"
      )
